...
type LoadingSpinnerProps = {
  className?: string;
  colorClassName?: string; // use a text-* class to control color
};

export function LoadingSpinner({ className = "", colorClassName = "text-primary" }: LoadingSpinnerProps) {
  return (
    <div className={`${colorClassName} ${className}`}>
